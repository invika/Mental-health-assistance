    ...
    stages {
        stage('Dev - Deployment'){
            steps {
                ...
                sh 'ssh -i /var/lib/jenkins/workspace/Jenkin.pem ubuntu@ec2-3-138-173-238.us-east-2.compute.amazonaws.com "/home/ubuntu/Mental-health-assistance/Jenkins/env_setup.sh > env_setup.log"'
                sh 'ssh -i /var/lib/jenkins/workspace/Jenkin.pem ubuntu@ec2-3-138-173-238.us-east-2.compute.amazonaws.com "/home/ubuntu/Mental-health-assistance/Jenkins/app_start.sh > app_start.log"'
            }
        }
    }
}