    ...
    stages {
        ...
        stage('Test - Deployment'){
            steps {
                ...
                sh 'ssh -i /var/lib/jenkins/workspace/Jenkin.pem ubuntu@ec2-3-144-180-19.us-east-2.compute.amazonaws.com "git clone https://github.com/invika/Mental-health-assistance.git ~/"'
