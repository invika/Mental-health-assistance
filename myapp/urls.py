...
from .views import home, login, validate_login, register, edituser, updateuser, assistant, video_feed, healthreference, nearbydoctors, index, history
...
urlpatterns = [
    ...
    path('video_feed/', video_feed, name='video_feed'),##added video feed 
